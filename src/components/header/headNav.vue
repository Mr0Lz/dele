<template>
    <header class="head-nav">
        <section @click="$router.go(-1)"  class="go-back" >
            <!-- 直接使用svg -->
        <svg t="1537519950016" class="icon left" style="" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1044" xmlns:xlink="http://www.w3.org/1999/xlink" >
        ...
        <section class="other-btn">
            <head-more class="right"></head-more>
        </section>
    </header>
</template>
<script>
