<template>
  <canvas ref="dragBubble" :width="width" :height="height" :style="style"></canvas>
</template>
...
<script type="text/ecmascript-6">
  export default {
    ...
    methods: {
      _draw () {
        const dragBubble = this.$refs.dragBubble
        const ctx = dragBubble.getContext('2d')
        ctx.clearRect(0, 0, dragBubble.width, dragBubble.height)
