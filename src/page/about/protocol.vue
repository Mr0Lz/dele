<template>
    ...
    <section class="protocol page-container">
        <head-nav title="服务协议" :goback="true"></head-nav>

        <section class="protocol-container">
            <p class="h-2 m-l m-t">服务协议</p>
            <div class="protocol-info  m-l m-r">
                <p class="h-2">一、服务条款的确认和接纳</p>
                <p>本站的各项电子服务的所有权和运作权归本站。本站提供的服务将完全按照其发布的服务条款和操作规则严格执行。如果您对本协议的条款有疑问的，请通过客服在线询问，我们将向您解释条款内容。用户必须完全同意所有服务条款并完成注册程序，才能成为本站的正式用户。本协议条款是处理双方权利义务的当然约定依据，除非违反国家强制性法律，否则始终有效。在下订单的同时，您也同时承认了您拥有购买这些产品的权利能力和行为能力，并且将您对您在订单中提供的所有信息的真实性负责。 </p>
                <p class="h-2">二、服务简介 </p>
                <p>本站运用自己的操作系统通过国际互联网络为用户提供网络服务。同时，用户须自行配备上网的所需设备，包括个人电脑、调制解调器或其它必备上网装置；自行负担个人上网所支付的与此服务有关的电话费用、网络费用。 </p>
                <p>本站不公开用户的姓名、地址、电子邮箱和笔名， 除以下情况外： </p>
                <p>(1)用户授权本站透露这些信息； </p>
                <p>(2)相应的法律及程序要求本站提供用户的个人资料。 </p>
                <p>如果用户提供的资料包含有不正确的信息，本站保留结束用户使用网络服务资格的权利。 </p>
                <p class="h-2">三、价格和数量 </p>
                <p>本站将尽最大努力保证您所购商品与网站上公布的价格一致，但价目表和声明并不构成要约。本站有权在发现了其网站上显现的产品及订单的明显错误或缺货的情况下，单方面撤回任何承诺。同时，本站保留对产品订购的数量的限制权。 </p>
                <p>产品的价格和可获性都在本站上指明。这类信息将随时更改且不发任何通知。商品的价格都包含了增值税。如果发生了意外情况，在确认了您的订单后，由于供应商提价，税额变化引起的价格变化，或是由于网站的错误等造成商品价格变化，您有权取消您的订单，并希望您能及时通过在线客服或拨打电话热线 400-805-7773 告知客户服务部。 </p>
                <p>您所订购的商品，如果发生缺货，您有权取消订单。 </p>
                <p class="h-2">四、送货及费用 </p>
                <p>本站将会把产品送到您所指定的送货地址。所有在本站上列出的送货时间为参考时间，参考时间的计算是根据库存状况、正常的处理过程和送货时间、送货地点的基础上估计得出的。送货费用根据您选择的配送方式的不同而异。 请清楚准确地填写您的真实姓名、送货地址及联系方式。因如下情况造成订单延迟或无法配送等，本站将不承担责任： </p>
                <p>(1)客户提供错误信息和不详细的地址； </p>
                <p>(2)货物送达无人签收，由此造成的重复配送所产生的费用及相关的后果； </p>
                <p>(3)不可抗力，例如：自然灾害、交通戒严、突发战争等。 </p>
                <p class="h-2">五、服务条款的修改 </p>
                ...
                <p class="h-2">六、用户隐私制度 </p>
                <p>用户一旦注册成功，成为本站的合法用户，将得到一个密码和用户名。您可随时根据指示改变您的密码。用户将对用户名和密码安全负全部责任。 
                <p>另外，每个用户都要对以其用户名进行的所有活动和事件负全责。用户若发现任何非法使用用户帐号或存在安全漏洞的情况，</p>
                <p>请立即联系在线客服或客户服务热线：</p>
                <p>400-805-7773 </p>
                <p>本站一定不会在未经合法用户授权时公开、编辑或透露其注册资料及保存在本站中的非公开内容，除非有法律许可要求或本站在诚信的基础上认为透露这些信件在以下四种情况是必要的： 
                <p>(1)遵守有关法律规定，遵从本站合法服务程序； </p>
                <p>(2)保持维护本站的商标所有权； </p>
                <p>(3)在紧急情况下竭力维护用户个人和社会大众的隐私安全； </p>
                <p>(4)符合其它相关的要求。 </p>
                <p class="h-2">七、拒绝提供担保 </p>
                ...
                <p class="h-2">九、结束服务 </p>
                <p>用户或本站可随时根据实际情况中断一项或多项网络服务。本站不需对任何个人或第三方负责而随时中断服务。用户对后来的条款修改有异议，或对本站的服务不满，可以选择停止使用本站的网络服务。 如您在平台交易过程中发生争议的，有权选择以下途径解决： </p>
                <p>(1)与争议相对方自主协商； </p>
                <p>(2)请求消费者协会或者其他依法成立的调解组织调解； </p>
                <p>(3)向有关行政部门投诉； </p>
                <p>(4)根据与争议相对方达成的仲裁协议（如有）提请仲裁机构仲裁； </p>
                <p>(5)向人民法院提起诉讼。 </p>
                <p>结束用户服务后，用户使用网络服务的权利马上中止。从那时起，用户有权利，本站也没有义务传送任何未处理的信息或未完成的服务给户或第三方。 </p>
                <p class="h-2">十、网络服务内容的所有权 </p>
